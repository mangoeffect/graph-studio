<#
.SYNOPSIS
    Thin shim: forwards to the cross-platform build_plugin_standalone.py (deprecated, will be removed next release).
#>
...
$script = Join-Path $ScriptDir "build_plugin_standalone.py"
