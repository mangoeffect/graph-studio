...
Pyramid upsample (`cv::pyrUp`). Doubles the size then applies a Gaussian; the inverse of `opencv_pyr_down` (a round trip loses high frequencies).

**Module**：OpenCV filtering · **Task type**：`opencv_pyr_up`
