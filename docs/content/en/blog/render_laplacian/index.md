...
Render-pipeline Laplacian: k=3 is the diagonal 8-neighborhood kernel [[2,0,2],[0,-8,0],[2,0,2]] (OpenCV calibration), k=1 the 4-neighborhood — differing from textbook writeups; trust the parameter table.

**Module**：GPU render · **Task type**：`render_laplacian`
...
| `ksize` | int | `3` | [1, 7] (step 2) | kernel edge length in pixels; must be a positive odd number |
