...
Render-pipeline thresholding: pixels below the threshold go to 0. Same semantics as compute-side `gpu_threshold`, but texture-resident output chains into further render effects.

**Module**：GPU render · **Task type**：`render_threshold`
