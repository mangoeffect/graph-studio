...
GPU version of the linear tonal adjustment, semantics of `opencv_brightness_contrast`. A permanent node in realtime preview chains.

**Module**：GPU image processing · **Task type**：`gpu_brightness_contrast`
