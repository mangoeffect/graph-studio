...
Identity rendering: upload to texture and download again; verifies the render path and format conversions. The do-nothing control while debugging render chains.

**Module**：GPU render · **Task type**：`render_passthrough`
