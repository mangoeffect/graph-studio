...
Render-pipeline Scharr: the smoothing kernel is calibrated from the local OpenCV impulse response as [3,10,3] (the textbook [1,2,1] is wrong); interior error ≤1.

**Module**：GPU render · **Task type**：`render_scharr`
