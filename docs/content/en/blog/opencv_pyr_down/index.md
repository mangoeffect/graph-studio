...
Pyramid downsample (`cv::pyrDown`). Gaussian-blurs then drops every other row/column, halving the size — far less moiré than a direct resize.

**Module**：OpenCV filtering · **Task type**：`opencv_pyr_down`
