...
Matrix transpose (`cv::transpose`). Width and height swap; equals a mirror across the main diagonal.

**Module**：OpenCV geometry · **Task type**：`opencv_transpose`
