...
GPU flip: coordinate swap in the shader per flip code, semantics of `opencv_flip`.

**Module**：GPU image processing · **Task type**：`gpu_flip`
...
| 参数 | 类型 | 默认值 | 范围 / 选项 | 说明 |
|---|---|---|---|---|
| `flip` | enum | `1` | `up_down` / `left_right` / `both` |  |
