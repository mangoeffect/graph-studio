...
Linear tonal adjustment: `out = in * contrast + brightness`. The most common look-tuning node; usually sits before BCS in a grading chain for base correction.

**Module**：OpenCV enhancement · **Task type**：`opencv_brightness_contrast`
...
```json
{
  ...
  "tasks": [
    ...
    {
      "id": "node",
      "type": "opencv_brightness_contrast",
      "params": {
        "brightness": 0,
        "contrast": 1
      }
