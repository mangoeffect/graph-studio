...
Morphological dilation (`cv::dilate`). White regions expand by the kernel shape; used to bridge broken strokes and beef up bright targets. Inverse of `opencv_erode`.

**Module**：OpenCV filtering · **Task type**：`opencv_dilate`
