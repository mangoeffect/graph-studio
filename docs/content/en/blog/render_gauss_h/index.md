...
Fixed 5-tap binomial Gaussian, horizontal. Chain with `render_gauss_v` for a 2D Gaussian (equivalent to gauss_dir × 2 in a pipeline).

**Module**：GPU render · **Task type**：`render_gauss_h`
